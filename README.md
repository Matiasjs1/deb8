...
- Creación y gestión de debates (voz o texto, por turnos o libre).  
- Participación de 2 a 4 personas por debate.  
- Moderación con votación unánime para expulsiones.  
- Sistema de sanciones por mal comportamiento.  
- Estadísticas personales de usuario.  
- Gestión de contactos y debates privados.  
- Interfaz intuitiva, modo oscuro y adaptable a móviles.  
- Seguridad con cifrado, antispam y verificación opcional.  
- Carga rápida y soporte para múltiples usuarios activos.  
